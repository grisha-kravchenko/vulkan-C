...
void initialise(Program* program) {
	...
	Vec instance_extensions = vec_from_array(sizeof(char*), glfw_extensions, glfw_extension_count);
	vec_push_str(&instance_extensions, VK_KHR_SURFACE_EXTENSION_NAME);
#ifdef DEBUG
	vec_push_str(&instance_extensions, VK_EXT_DEBUG_UTILS_EXTENSION_NAME);
#endif
	...
	VkInstanceCreateInfo create_info = {
		...
		0, NULL,
#endif
		instance_extensions.count, instance_extensions.values,
	};
	...
	printf("%s: %i\n", propeties.deviceName, propeties.deviceType);
#endif
